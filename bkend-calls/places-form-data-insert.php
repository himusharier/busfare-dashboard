...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($sql_status == 'done') {
        ...
        echo "<div class='reg-form-message-green'><br/><i class='fa fa-check'></i> <b>Place Added Successfully!</b><br/><br/><a href='admin/add-new-place' type='button' onclick='showForm();' name='renew-btn' class='cancel-btn' style='display: inline-block;padding: 10px 20px; border-radius: 4px; margin: 30px 0;'><i class='fa fa-plus'></i> Add Another Place</a></div>";
